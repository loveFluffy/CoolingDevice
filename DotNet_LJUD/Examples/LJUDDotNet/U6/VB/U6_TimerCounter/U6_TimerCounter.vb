...
#End Region
    ...
    Private Sub goButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles goButton.Click
        ...
        Try
            ...
            u6 = New U6(LJUD.CONNECTION.USB, "1", True)
            ...
            LJUD.AddRequest(u6.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.TIMER_CLOCK_BASE, LJUD.TIMERCLOCKS.MHZ48_DIV, 0, 0)
        ...
        Try
            ...
            LJUD.eGet(u6.ljhandle, LJUD.IO.GET_COUNTER, 1, dblValue, dummyDoubleArray)
            ...
            'it to input.
            LJUD.eGet(u6.ljhandle, LJUD.IO.GET_DIGITAL_BIT, 0, dblValue, dummyDoubleArray)
        Catch ex As LabJackUDException
            showErrorMessage(ex)
        End Try
    End Sub
