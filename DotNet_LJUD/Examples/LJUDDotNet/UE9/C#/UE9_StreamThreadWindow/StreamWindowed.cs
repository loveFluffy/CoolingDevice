//---------------------------------------------------------------------------
//
//  UE9_StreamWindowed.cs
// 
//	Display of 2-channel stream from the UE9 on a GUI window
//  NOTE: This is only to demonstrate the use of threads with
...
namespace UE9_StreamWindowed
{
	...
	public class StreamForm : System.Windows.Forms.Form
	{
		...
		/// <summary>
		/// Set up stream and then start the stream thread or,
		/// if the stream has already started, end the stream and
		/// thread.
		/// </summary>
