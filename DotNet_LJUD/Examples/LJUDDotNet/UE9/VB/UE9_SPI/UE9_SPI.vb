...
#End Region
    ...
    Private Sub goButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles goButton.Click
        ...
        Try
            ...
            LJUD.ePut(ue9.ljhandle, LJUD.IO.PIN_CONFIGURATION_RESET, 0, 0, 0)
            ...
            'CLK is FIO4
            LJUD.AddRequest(ue9.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.SPI_CLK_PIN_NUM, 4, 0, 0)

            'CS is FIO5
            LJUD.AddRequest(ue9.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.SPI_CS_PIN_NUM, 5, 0, 0)
        ...
        Try
            LJUD.eGet(ue9.ljhandle, LJUD.IO.SPI_COMMUNICATION, 0, numSPIBytesToTransfer, dataArray)
        Catch ex As LabJackUDException
            showErrorMessage(ex)
        End Try
