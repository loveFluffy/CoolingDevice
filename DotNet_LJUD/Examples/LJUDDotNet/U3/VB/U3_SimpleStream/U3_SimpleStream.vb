...
Public Class U3_SimpleStream
    ...
    'per read.  Since the data packets between host and U3 are 16 samples
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "U3_SimpleStream"
        Me.Text = "U3_SimpleStream"
...
#End Region
    ...
    Private Sub StopStream()
        Try
            'Stop the stream
            LJUD.eGet(u3.ljhandle, LJUD.IO.STOP_STREAM, 0, dummyDouble, dummyDoubleArray)
    ...
    Private Sub goButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles goButton.Click
        If Not running Then
            ...
            Try
                ...
                LJUD.AddRequest(u3.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.AIN_RESOLUTION, 12, 0, 0)

                'Set the scan rate.
                LJUD.AddRequest(u3.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.STREAM_SCAN_FREQUENCY, SCAN_RATE, 0, 0)

                'Give the driver a 5 second buffer (scanRate * 2 channels * 5 seconds).
                LJUD.AddRequest(u3.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.STREAM_BUFFER_SIZE, SCAN_RATE * 2 * 5, 0, 0)
                ...
                LJUD.AddRequest(u3.ljhandle, LJUD.IO.PUT_CONFIG, LJUD.CHANNEL.STREAM_WAIT_MODE, LJUD.STREAMWAITMODES.NONE, 0, 0)
                ...
                LJUD.AddRequest(u3.ljhandle, LJUD.IO.ADD_STREAM_CHANNEL, 1, 0, 0, 0)
            ...
            While Not isFinished
                Try
                    LJUD.GetNextResult(u3.ljhandle, ioType, channel, dummyDouble, dummyInt, dummyDouble)
                Catch ex As LabJackUDException
            ...
            Try
                'Start the stream.
                LJUD.eGet(u3.ljhandle, LJUD.IO.START_STREAM, 0, dblValue, 0)
            Catch ex As LabJackUDException
                showErrorMessage(ex)
            End Try
    ...
    Private Sub U3_SimpleStream_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Timer1.Enabled = False
    End Sub
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Try
            ...
            LJUD.eGet(u3.ljhandle, LJUD.IO.GET_STREAM_DATA, LJUD.CHANNEL.ALL_CHANNELS, numScansRequested, adblData)
            firstScanDisplay.Text = Str(adblData(0)) + ", " + Str(adblData(1))
            LJUD.eGet(u3.ljhandle, LJUD.IO.GET_CONFIG, LJUD.CHANNEL.STREAM_BACKLOG_COMM, dblValue, 0)
            commBacklogDisplay.Text = Str(dblValue)
            LJUD.eGet(u3.ljhandle, LJUD.IO.GET_CONFIG, LJUD.CHANNEL.STREAM_BACKLOG_UD, dblValue, 0)
