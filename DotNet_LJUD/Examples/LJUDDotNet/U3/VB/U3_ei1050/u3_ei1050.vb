...
#End Region
    ...
    Private Sub runButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles runButton.Click
        ...
        Try
            ...
            LJUD.ePut(u3.ljhandle, LJUD.IO.PUT_DIGITAL_BIT, 6, 1, 0)
        ...
        If radioOne.Checked Then
            ...
            Try
                ...
                LJUD.GetResult(u3.ljhandle, LJUD.IO.SHT_GET_READING, LJUD.CHANNEL.SHT_TEMP, dblValue)
                ...
                LJUD.GetResult(u3.ljhandle, LJUD.IO.SHT_GET_READING, LJUD.CHANNEL.SHT_RH, dblValue)
        ...
        ElseIf radioTwo.Checked Then
            ...
            Try
                ...
                LJUD.ePut(u3.ljhandle, LJUD.IO.PUT_DIGITAL_BIT, 7, 0, 0)
                ...
                LJUD.ePut(u3.ljhandle, LJUD.IO.PUT_DIGITAL_BIT, 7, 1, 0)
